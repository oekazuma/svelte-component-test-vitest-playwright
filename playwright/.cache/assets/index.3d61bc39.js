...
/* src/lib/Counter.svelte generated by Svelte v3.53.1 */
...
function create_fragment(ctx) {
	...
	let div0;
	let strong0;
	let t2_value = Math.floor(/*$displayed_count*/ ctx[1] + 1) + "";
	let t2;
	let t3;
	let strong1;
	let t4_value = Math.floor(/*$displayed_count*/ ctx[1]) + "";
	let t4;
	let t5;
	let button1;
	let t6;
	...
	return {
		...
		l(nodes) {
			...
			t2 = claim_text(strong0_nodes, t2_value);
			strong0_nodes.forEach(detach);
			t3 = claim_space(div0_nodes);
			strong1 = claim_element(div0_nodes, "STRONG", { class: true });
			var strong1_nodes = children(strong1);
			t4 = claim_text(strong1_nodes, t4_value);
		...
		h() {
			...
			attr(button0, "class", "svelte-gesjv8");
			attr(strong0, "class", "hidden svelte-gesjv8");
			attr(strong0, "aria-hidden", "true");
			attr(strong1, "class", "svelte-gesjv8");
			attr(div0, "class", "counter-digits svelte-gesjv8");
			set_style(div0, "transform", "translate(0, " + 100 * /*offset*/ ctx[2] + "%)");
			attr(div1, "class", "counter-viewport svelte-gesjv8");
			attr(button1, "aria-label", "Increase the counter by one");
			attr(button1, "class", "svelte-gesjv8");
			attr(div2, "class", "counter svelte-gesjv8");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			if (dirty & /*$displayed_count*/ 2 && t2_value !== (t2_value = Math.floor(/*$displayed_count*/ ctx[1] + 1) + "")) set_data(t2, t2_value);
			if (dirty & /*$displayed_count*/ 2 && t4_value !== (t4_value = Math.floor(/*$displayed_count*/ ctx[1]) + "")) set_data(t4, t4_value);
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*$displayed_count*/ 2) {
...
register({ _lib_Counter_svelte: Counter });
//# sourceMappingURL=index.3d61bc39.js.map
